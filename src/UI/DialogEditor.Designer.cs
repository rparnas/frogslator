namespace Frogslator
{
  partial class DialogEditor
  {
    ...
    private void InitializeComponent()
    {
      ...
      lbl_UsefulGlyphs.Size = new Size(250, 15);
      lbl_UsefulGlyphs.TabIndex = 7;
      lbl_UsefulGlyphs.Text = "Useful Glyphs (copy-paste to Translation Text):";
      // 
      // tb_UsefulGlyphs
      // 
      tb_UsefulGlyphs.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      tb_UsefulGlyphs.Font = new Font("Courier New", 14.25F, FontStyle.Bold, GraphicsUnit.Point, 0);
      ...
      lbl_Block3Bytes.Location = new Point(14, 738);
      ...
      lbl_Block2Bytes.Location = new Point(14, 720);
      ...
      lbl_Block1Bytes.Location = new Point(14, 703);
      ...
      lbl_Block0Bytes.Location = new Point(14, 685);
      ...
      lbl_SearchInText.Location = new Point(285, 21);
      lbl_SearchInText.Margin = new Padding(4, 0, 4, 0);
      lbl_SearchInText.Name = "lbl_SearchInText";
      lbl_SearchInText.Size = new Size(82, 15);
      lbl_SearchInText.TabIndex = 9;
      lbl_SearchInText.Text = "Search in Text:";
      // 
      // tb_SearchInText
      // 
      ...
      lb_Lines.Size = new Size(268, 634);
      lb_Lines.TabIndex = 1;
      // 
      // lbl_Lines
      // 
      ...
      // tb_Notes
      // 
      tb_Notes.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left;
      ...
      tb_Notes.Size = new Size(716, 222);
      tb_Notes.TabIndex = 8;
      // 
      // previewControl
      // 
      ...
      previewControl.Size = new Size(672, 111);
      ...
      tb_Translation.Size = new Size(714, 147);
      ...
      lbl_Translation.Size = new Size(67, 15);
      ...
      cb_Skip.Location = new Point(7, 710);
      cb_Skip.Margin = new Padding(4, 3, 4, 3);
      cb_Skip.Name = "cb_Skip";
      cb_Skip.Size = new Size(368, 19);
      cb_Skip.TabIndex = 9;
      cb_Skip.Text = "Skip (Line is changed to empty string as it is unused in the game)";
      ...
      label1.TabIndex = 11;
      label1.Text = "Search in Translation:";
      // 
      ...
      cb_FilterUntranslated.Location = new Point(876, 57);
      ...
      cb_FilterErrors.Location = new Point(876, 36);
      ...
      cb_SixLetterNames.Location = new Point(876, 15);
      cb_SixLetterNames.Margin = new Padding(4, 3, 4, 3);
      cb_SixLetterNames.Name = "cb_SixLetterNames";
      cb_SixLetterNames.Size = new Size(147, 19);
      cb_SixLetterNames.TabIndex = 10;
      cb_SixLetterNames.Text = "Assume 6-Letter Name";
