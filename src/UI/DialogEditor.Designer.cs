namespace Frogslator
{
  partial class DialogEditor
  {
    ...
    private void InitializeComponent()
    {
      ...
      lbl_UsefulGlyphs.Size = new Size(223, 15);
      lbl_UsefulGlyphs.TabIndex = 7;
      lbl_UsefulGlyphs.Text = "Useful Glyphs (copy-paste to Translation)";
      // 
      // tb_UsefulGlyphs
      // 
      ...
      tb_UsefulGlyphs.Size = new Size(231, 29);
      ...
      lbl_SearchInText.Location = new Point(248, 21);
      ...
      tb_SearchInText.Location = new Point(248, 42);
      ...
      tb_SearchInTranslation.Location = new Point(436, 41);
      ...
      cb_FindTrailingWhitespace.Location = new Point(811, 58);
      ...
      label2.Location = new Point(624, 23);
      ...
      tb_SearchInNotes.Location = new Point(624, 41);
      ...
      cb_FilterUntranslated.Location = new Point(811, 39);
      ...
      cb_FilterErrors.Location = new Point(811, 19);
      ...
      cb_SixLetterNames.Location = new Point(904, 19);
      cb_SixLetterNames.Margin = new Padding(4, 3, 4, 3);
      cb_SixLetterNames.Name = "cb_SixLetterNames";
      cb_SixLetterNames.Size = new Size(132, 19);
      cb_SixLetterNames.TabIndex = 10;
      cb_SixLetterNames.Text = "6-Char Player Name";
